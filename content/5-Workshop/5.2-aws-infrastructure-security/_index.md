...
## 5.2 AWS infrastructure and security foundation
...
1. [5.2.1 VPC and networking](5.2.1-vpc-network/).
2. [5.2.2 Frontend Hosting and Content Distribution](5.2.2-client-facing/) 
3. [5.2.3 Backend and Processing Platform](5.2.3-backend-platform/)
4. [5.2.4 Database and Data Security](5.2.4-database/).