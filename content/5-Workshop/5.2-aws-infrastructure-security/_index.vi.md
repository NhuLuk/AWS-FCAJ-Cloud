...
## 5.2 Nền tảng hạ tầng AWS, phân lớp mạng và bảo mật
...
1. [5.2.1 VPC và mạng](5.2.1-vpc-network/).
2. [5.2.2 Frontend Hosting và phân phối nội dung](5.2.2-client-facing/).
3. [5.2.3 Backend và nền tảng xử lý](5.2.3-backend-platform/).
4. [5.2.4 Cơ sở dữ liệu và bảo mật dữ liệu](5.2.4-database/).